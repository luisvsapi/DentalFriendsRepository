...
async function sendMail(pacient, dentistDetails, appointment) {
    ...
    const oAuth2Client =  new google.auth.OAuth2(oAuth2Credentials.clientId,
        oAuth2Credentials.clientSecret,oAuth2Credentials.redirectURI)
    ...
    var dateToStringBegin = utils.addNameDay(dateBeginAppointment,dateToStringBegin) + ", " + dateBeginAppointment.getDate + " de " 
    dateToStringBegin = utils.addNameMonth(dateBeginAppointment, dateToStringBegin) + " de " + dateBeginAppointment.getFullYear()
    ...
    try {
        ...
        switch (appointment.state) {
            ...
            default:
                ...
                mailParams.message = 'Su cita está pendiente de confirmación, para su inmediata asignación de la hora, en el día escogido'               
